...
namespace KenChessPGNCoreLibrary
{
    public static class UtilitiesLegalUCIMoves
    {
        ...
        {
            List<string> listLegalUciMoves = new List<string>();
            for (int fileIndex = 0; fileIndex < 8; fileIndex++)
            {
                for (int rankIndex = 0; rankIndex < 8; rankIndex++)
                {
                    ...
                    {
                        if ((pieceTypeFilter == '*') || (pieceTypeFilter == 'K') || (pieceTypeFilter == 'k'))
                        {
                            listLegalUciMoves.AddRange(getAllLegalUciMovesForKingNonCastlingOnSpecificSquare(chessBoard, chessSquare));
                        }
                    }
                    if (chessSquare.PieceOnSquare.PieceType == PieceType.King)
                    {
                        if ((pieceTypeFilter == '*') || (pieceTypeFilter == 'K') || (pieceTypeFilter == 'k'))
                        {
                            listLegalUciMoves.AddRange(getAllLegalUciMovesForCastlingByActivePlayer(chessBoard, chessSquare));
                        }
                    }
                    if (chessSquare.PieceOnSquare.PieceType == PieceType.Knight)
                    {
                        if ((pieceTypeFilter == '*') || (pieceTypeFilter == 'N') || (pieceTypeFilter == 'n'))
                        {
                            listLegalUciMoves.AddRange(getAllLegalUciMovesForKnightOnSpecificSquare(chessBoard, chessSquare));
                        }
                    }
                    if (chessSquare.PieceOnSquare.PieceType == PieceType.Rook)
                    {
                        if ((pieceTypeFilter == '*') || (pieceTypeFilter == 'R') || (pieceTypeFilter == 'r'))
                        {
                            listLegalUciMoves.AddRange(getAllLegalUciMovesForRookOnSpecificSquare(chessBoard, chessSquare));
                        }
                    }
                    if (chessSquare.PieceOnSquare.PieceType == PieceType.Bishop)
                    {
                        if ((pieceTypeFilter == '*') || (pieceTypeFilter == 'B') || (pieceTypeFilter == 'b'))
                        {
                            listLegalUciMoves.AddRange(getAllLegalUciMovesForBishopOnSpecificSquare(chessBoard, chessSquare));
                        }
                    }
                    if (chessSquare.PieceOnSquare.PieceType == PieceType.Queen)
                    {
                        if ((pieceTypeFilter == '*') || (pieceTypeFilter == 'Q') || (pieceTypeFilter == 'q'))
                        {
                            listLegalUciMoves.AddRange(getAllLegalUciMovesForQueenOnSpecificSquare(chessBoard, chessSquare));
                        }
                    }
                    if ((chessBoard.ActivePlayer == 'w') && (chessSquare.PieceOnSquare.PieceType == PieceType.Pawn))
                    {
                        if ((pieceTypeFilter == '*') || (pieceTypeFilter == 'P') || (pieceTypeFilter == 'p'))
                        {
                            listLegalUciMoves.AddRange(getAllLegalUciMovesForWhitePawnOnSpecificSquare(chessBoard, chessSquare));
                        }
                    }
                    if ((chessBoard.ActivePlayer == 'b') && (chessSquare.PieceOnSquare.PieceType == PieceType.Pawn))
                    {
                        if ((pieceTypeFilter == '*') || (pieceTypeFilter == 'P') || (pieceTypeFilter == 'p'))
                        {
                            listLegalUciMoves.AddRange(getAllLegalUciMovesForBlackPawnOnSpecificSquare(chessBoard, chessSquare));
                        }
                    }
                }
            }
            return listLegalUciMoves;
        }
        /// <summary>
        ...
        public static List<string> getAllLegalUciMovesForWhitePawnOnSpecificSquare(ChessBoard chessBoard, ChessSquare startingChessSquare)
        {
            ...
            if (startingChessSquare.PieceOnSquare.PieceColor == 'w')
            {
                ...
                {
                    if (squareAdjacentNorthEast.UciSquareName.EndsWith("8"))
                    {
                        listPossibleUciMoves.Add(startingChessSquare.UciSquareName + squareAdjacentNorthEast.UciSquareName + "q");
                        listPossibleUciMoves.Add(startingChessSquare.UciSquareName + squareAdjacentNorthEast.UciSquareName + "r");
                        listPossibleUciMoves.Add(startingChessSquare.UciSquareName + squareAdjacentNorthEast.UciSquareName + "b");
                        listPossibleUciMoves.Add(startingChessSquare.UciSquareName + squareAdjacentNorthEast.UciSquareName + "n");
                    }
                    else
                    {
                ...
                {
                    if (squareAdjacentNorthWest.UciSquareName.EndsWith("8"))
                    {
                        listPossibleUciMoves.Add(startingChessSquare.UciSquareName + squareAdjacentNorthWest.UciSquareName + "q");
                        listPossibleUciMoves.Add(startingChessSquare.UciSquareName + squareAdjacentNorthWest.UciSquareName + "r");
                        listPossibleUciMoves.Add(startingChessSquare.UciSquareName + squareAdjacentNorthWest.UciSquareName + "b");
                        listPossibleUciMoves.Add(startingChessSquare.UciSquareName + squareAdjacentNorthWest.UciSquareName + "n");
                    }
                    else
                    {
        ...
        public static List<string> getAllLegalUciMovesForBlackPawnOnSpecificSquare(ChessBoard chessBoard, ChessSquare startingChessSquare)
        {
            ...
            if (startingChessSquare.PieceOnSquare.PieceColor == 'b')
            {
                ...
                {
                    if (squareAdjacentSouth.UciSquareName.EndsWith("1"))
                    {
                ...
                {
                    if (squareAdjacentSouthEast.UciSquareName.EndsWith("1"))
                    {
                        listPossibleUciMoves.Add(startingChessSquare.UciSquareName + squareAdjacentSouthEast.UciSquareName + "q");
                        listPossibleUciMoves.Add(startingChessSquare.UciSquareName + squareAdjacentSouthEast.UciSquareName + "r");
                        listPossibleUciMoves.Add(startingChessSquare.UciSquareName + squareAdjacentSouthEast.UciSquareName + "b");
                        listPossibleUciMoves.Add(startingChessSquare.UciSquareName + squareAdjacentSouthEast.UciSquareName + "n");
                    }
                    else
                    {
                ...
                {
                    if (squareAdjacentSouthWest.UciSquareName.EndsWith("1"))
                    {
                        listPossibleUciMoves.Add(startingChessSquare.UciSquareName + squareAdjacentSouthWest.UciSquareName + "q");
                        listPossibleUciMoves.Add(startingChessSquare.UciSquareName + squareAdjacentSouthWest.UciSquareName + "r");
                        listPossibleUciMoves.Add(startingChessSquare.UciSquareName + squareAdjacentSouthWest.UciSquareName + "b");
                        listPossibleUciMoves.Add(startingChessSquare.UciSquareName + squareAdjacentSouthWest.UciSquareName + "n");
                    }
                    else
                    {
        ...
        public static List<string> getAllLegalUciMovesForPieceToSquare(ChessBoard chessBoard, char pieceTypeFilter, string uciSquareName)
        {
            List<string> allLegalUciMovesToSpecificSquare = new List<string>();
            List<string> allLegalUciMovesForPiece = getAllLegalUciMovesForActivePlayer(chessBoard, pieceTypeFilter);
            foreach (string uciMove in allLegalUciMovesForPiece)
            {
                if (uciMove.Substring(2,2).Equals(uciSquareName))
                {
                    allLegalUciMovesToSpecificSquare.Add(uciMove);
                }
            }
            return allLegalUciMovesToSpecificSquare;
        }
        public static bool IsLegalMove(ChessBoard chessBoard, string uciMove)
        {
            bool isLegal = false;
            string uciFrom = uciMove.Substring(0, 2);
            ChessSquare chessSquare = chessBoard.getChessSquareWithUciName(uciFrom);
            ChessPiece chessPiece = chessSquare.PieceOnSquare;
            if ((chessBoard.ActivePlayer == chessPiece.PieceColor) && (chessPiece.PieceType != PieceType.None))
            {
                List<string> listLegalUciMoves = new List<string>();
                ...
                else if (chessPiece.PieceType == PieceType.Pawn)
                {
                    if (chessBoard.ActivePlayer == 'w')
                    {
                        listLegalUciMoves.AddRange(getAllLegalUciMovesForWhitePawnOnSpecificSquare(chessBoard, chessSquare));
                    }
                    if (chessBoard.ActivePlayer == 'b')
                    {
                        listLegalUciMoves.AddRange(getAllLegalUciMovesForBlackPawnOnSpecificSquare(chessBoard, chessSquare));
                    }
                }
                isLegal = listLegalUciMoves.Contains(uciMove);
            }
